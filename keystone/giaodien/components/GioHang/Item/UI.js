...
import ChiTietDonHangUpdateUI from "../../ChiTietDonHang/Update/UI";
  ...
  return (
    <Fragment>
      {gioHang?.chiTietDonHang.map((chiTietDonHang) => {
        return <ChiTietDonHangUpdateUI chiTietDonHang={chiTietDonHang} />;
      })}
      {/* <hr />
      <br />
      <Grid
      ...
      >
        <GridItem rowSpan={1} colSpan={2}>
          <Center mb={20}>
            <Image
              src={gioHang.chiTietDonHang[0]?.sach?.IMG[0]?.anh?.publicUrl}
              alt="Segun Adebayo"
              boxSize="120px"
            />
          </Center>
        ...
        <GridItem rowSpan={1} colSpan={1}>
          <Center mb={20}>{gioHang.chiTietDonHang[0]?.sach?.tenSach}</Center>
        </GridItem>
        <GridItem rowSpan={1} colSpan={1}>
          <Center>
            <HStack maxW="180px">
        ...
        <GridItem rowSpan={1} colSpan={1}>
          <Center>
            {new Intl.NumberFormat().format(gioHang.chiTietDonHang[0]?.tien)}đ
          </Center>
        </GridItem>
        <GridItem rowSpan={1} colSpan={1}>
          <Center>
